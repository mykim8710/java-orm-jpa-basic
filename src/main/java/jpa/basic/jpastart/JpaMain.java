...
//            em.persist(member);
            ...
            // 비지니스 로직 : 단건 조회
//            Member findMember = em.find(Member2.class, 1L); // id 1L의 회원 조회
...
//            findMember.setName("memberJPA");
            ...
            // JPQL로 전체 회원 검색
//            List<Member> findMembers = em.createQuery("select m from Member2 AS m", Member.class)
